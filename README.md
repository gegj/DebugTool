...
```text
https://gh-proxy.org/https://github.com/gegj/DebugTool/releases/latest/download/DebugTool.exe
```
...
```text
https://gh-proxy.org/https://github.com/gegj/DebugTool/releases/latest/download/latest.json
```
...
{
  "version": "1.1.8",
  "url": "https://gh-proxy.org/https://github.com/gegj/DebugTool/releases/latest/download/DebugTool.exe",
  "notes": "更新说明"
}
```
